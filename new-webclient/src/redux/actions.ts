...
export const actions = {
  ...
  createChannelStart: () => createAction(types.CREATE_CHANNEL_START),
  createChannelSuccess: (channel: model.Channel) => createAction(types.CREATE_CHANNEL_SUCCESS, channel),
  createChannelError: (error: string) => createAction(types.CREATE_CHANNEL_ERROR, error),
  ...
  updateChannelStart: () => createAction(types.UPDATE_CHANNEL_START),
  updateChannelSuccess: (channel: model.Channel) => createAction(types.UPDATE_CHANNEL_SUCCESS, channel),
  updateChannelError: (error: string) => createAction(types.UPDATE_CHANNEL_ERROR, error),
  wsChannelNew: (channel: model.Channel) => createAction(types.WS_CHANNEL_NEW, channel),
  wsChannelUpdate: (channel: model.Channel) => createAction(types.WS_CHANNEL_UPDATE, channel),
  wsChannelDelete: (channel: model.Channel) => createAction(types.WS_CHANNEL_DELETE, channel),
  wsMessageNew: (message: model.Message) => createAction(types.WS_MESSAGE_NEW, message),
  wsMessageUpdate: (message: model.Message) => createAction(types.WS_MESSAGE_UPDATE, message),
  wsMessageDelete: (message: model.Message) => createAction(types.WS_MESSAGE_DELETE, message),
